...
public class EndGameView extends BasicGameState {
	...
	public void init(GameContainer container, StateBasedGame game)
		...
		font2 = new TrueTypeFont(new Font("Verdane",  Font.BOLD, 60), false);	
	...
	public void render(GameContainer container, StateBasedGame game, Graphics arg2)
		...
		if(EcranDeValidation.mode == 2 || EcranDeValidation.mode == 4){
			if (Credit.J1.defeated()){
				font2.drawString(larg/3    , haut/4  , "Le vainquer est jouer1 " , Color.orange);

			}
			else{
				font2.drawString(larg/3    , haut/4  , "Le vainquer est jouer2" , Color.orange);
			}
...
//		font2.drawString(larg/3    , haut/4  , "GAME OVER" , Color.orange);
		...
		font.drawString(larg/2, haut/4 , "Joueur2 : Credit restant" , Color.orange);
